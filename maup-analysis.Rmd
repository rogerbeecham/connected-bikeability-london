...
So first we build up a dataset where for each edge station (`outside_station`) geometries for their village neighbours are stored, both the original and rescaled geometries.
...
Animate over the simulated data to generate a  [Hullman et al. 2015](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0142444)  of candidate maps, in so doing we experience uncertainty due to zoning effects.
