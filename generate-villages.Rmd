...
Then we manually aggregate selected localities and create new centroids for those aggregated localities.
...
```
The semi-spatial grid-layout of villages was generating using the web-tool published alongside [Meulemans et al. 2017](https://www.gicentre.net/small-multiples-with-gaps). EDIT: update using package with LP implementation (under development).
